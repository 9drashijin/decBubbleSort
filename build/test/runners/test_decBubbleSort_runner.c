...
extern void test_sortSmallestToRightMost_should_move_Smallest_to_the_end_for_2_element(void);
...
int main(void)
{
  ...
  RUN_TEST(test_sortSmallestToRightMost_should_move_Smallest_to_the_end_for_2_element, 31);
